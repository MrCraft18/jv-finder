        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                for (let i = 0; i < limit; i++) {
                    ...
                    //Wait for Author Name Element
                    await postElement.waitForSelector('a[aria-label]')

                    // page.on('console', msg => {
                    //     console.log('PAGE LOG:', msg.text());
                    // })

                    const post = await postElement.evaluate(element => {
                        return new Promise(async (resolve) => {
                            ...
                            resolve({
                                ...
                                images: imagesArray,
                                author: {
                                    name: authorElement ? authorElement.innerText : null,
